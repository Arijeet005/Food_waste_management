...
## Real-Time Donation Locator

- Frontend page: `/donations`
- Uses browser live geolocation (`watchPosition`) + OpenStreetMap + Leaflet
- Pulls nearby NGO data every 15 seconds
